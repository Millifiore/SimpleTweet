...
Had a bug where I wasnt able to publish tweets causing me to take extension on project. 
...
Had some troubles getting access to a developer Twitter account which led to limited accesseiblity to the api.
